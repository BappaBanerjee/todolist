...
function createConfiguration() {
    return {
        ...
        sources: {
            'todolist.sol': {
                content: fs.readFileSync(path.resolve(__dirname, 'contracts', 'todolist.sol'), 'utf8')
            },/*
...
//     switch (dependency) {
//         case 'todolist.sol':
//             return {contents: fs.readFileSync(path.resolve(__dirname, 'contracts', 'todolist.sol'), 'utf8')};
